...
CANDIDATES: dict[str, Candidate] = {
    ...
    "omoi": Candidate(
        ...
        display_name="Omoi",
        aliases=(),
        vocadb_artist_id=10137,
        top100_name="Omoi",
    ),
    "oster_project": Candidate(
        rank=32,
        slug="oster_project",
        display_name="OSTER project",
        aliases=("OSTER", "ふわふわシナモン", "Fuwafuwa Cinnamon"),
        vocadb_artist_id=58,
        top100_name="OSTER project",
    ),
    "toma": Candidate(
        rank=33,
        slug="toma",
        display_name="トーマ",
        aliases=("Tohma", "Toma", "Gyoson", "魚"),
        vocadb_artist_id=153,
        top100_name="トーマ",
    ),
    "gyari": Candidate(
        rank=36,
        slug="gyari",
        display_name="GYARI",
        aliases=("ココアシガレットP", "Cocoa CigaretteP"),
        vocadb_artist_id=717,
        top100_name="GYARI（ココアシガレットP）",
    ),
    "eve": Candidate(
        rank=39,
        slug="eve",
