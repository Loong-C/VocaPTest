...
> **当前状态更新（2026-06-13）**
>
> 本文主体保留 20 类阶段的模型消融记录。生产目录现已扩展为 27 位 P 主、
> 309 首训练曲和 54 首严格隔离的冻结测试曲；27 类分组 CV Top-1 为 86.73%，
> 冻结测试 Top-1 为 87.04%。当前实现、错误分析和复现入口见
> [P1 27 类扩展与冻结测试总报告](P1_27_PRODUCERS_FROZEN_TEST_REPORT.md)。
